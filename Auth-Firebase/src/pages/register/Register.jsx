...
const Register = () => {
    ...
    const registerWithGoogle = () => {
        ...
        signInWithPopup(auth, provider)
            ...
            .catch((error) => {
                ...
                setErrorAlertMessage('Error al registrar con Google. Por favor, inténtalo de nuevo.');
            });
    };
    ...
    const handleRegistration = async (e) => {
        ...
        try {
            ...
            setShowErrorAlert(true);
            setErrorAlertMessage('Error al registrar. Por favor, verifica tus datos e inténtalo de nuevo.');
        }
    };
        ...
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "100vh" }}>
            <Card style={{ width: "300px" }}>
                <Card.Body>
                    ...
                    <Button variant="danger" className="w-100" onClick={registerWithGoogle}>
