  ...
  return (
    <div className="container mt-5">
      ...
      <div className="text-center">
        ...
        <p>
          Optimiza tu espacio, mejora la eficiencia y aumenta la productividad
          de tu bodega con nuestra solución integral.
        </p>
      ...
      <CardGroup className="mt-5">
        <Card className="text-center">
          <Card.Body>
            ...
            <Card.Text>
              Monitorea tu inventario con informes y análisis en tiempo real
        ...
        <Card className="text-center">
          <Card.Body>
            ...
            <Card.Text>
              Automatiza los procesos de recepción, almacenamiento y despacho
